...
export class Items {
  static items = [
    ...
    { tag: 'IceCreamSundae_01', correctAnswer: 'SET_ME', lang: "Zmrzlinovy pohár" },
    ...
    { tag: 'PlasticCoffeeCup_01', correctAnswer: 'SET_ME', lang: "Plastový pohár" },
    { tag: 'PlasticCoffeeCup_02', correctAnswer: 'SET_ME', lang: "Plastový pohár" },
    { tag: 'Plunger_01', correctAnswer: 'SET_ME', lang: "Piest" },
    { tag: 'PopCorn_01', correctAnswer: 'SET_ME', lang: "PopCorn" },
    { tag: 'RolledPaper_01', correctAnswer: 'SET_ME', lang: "Zrolovaný papier" },
    ...
    { tag: 'WalkingStick_01', correctAnswer: 'SET_ME', lang: "Palica na chodenie" },
